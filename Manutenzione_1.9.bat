...
echo 3  - Ricerca ID Pacchetti Winget
echo 4  - Aggiorna Driver
echo 5  - Aggiorna Sistema Operativo (Windows Update)
echo 6  - Pulizia del disco
echo 7  - Controlla e ripara il sistema (SFC e DISM)
echo 8  - Ottimizza la RAM
echo 9  - Deframmenta o ottimizza il disco (HDD/SSD)
...
echo 15 - Riavvia il sistema
echo 16 - Visualizza aiuto di Winget
echo 17 - Uscita
echo -----------------------------------------------------------
...
if "%scelta%"=="15" goto riavvio
if "%scelta%"=="16" goto help
if "%scelta%"=="17" goto end
