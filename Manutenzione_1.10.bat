...
echo 00  - Crea un punto di ripristino 
echo 01  - Aggiorna programmi con Winget
echo 02  - Aggiorna programmi con Winget (inclusi sconosciuti)
echo 03  - Ricerca ID Pacchetti Winget
echo 04  - Aggiorna Driver
echo 05  - Aggiorna Sistema Operativo (Windows Update)
echo 06  - Pulizia del disco
echo 07  - Controlla e ripara il sistema (SFC e DISM)
echo 08  - Ottimizza la RAM
echo 09  - Deframmenta o ottimizza il disco (HDD/SSD)
echo 10  - Tweak di sistema (ottimizzazione prestazioni, memoria, rete)
echo 11 - Blocca permanentemente un sito web
echo 12 - Gestione Periferiche
echo 13 - Gestione Disco
echo 14 - Attivazione Windows e Office
echo 15 - Valutazione PC per installazione Windows 11
echo 16 - Riavvia il sistema
echo 17 - Visualizza aiuto di Winget
echo 18 - Uscita
echo -----------------------------------------------------------
...
if "%scelta%"=="3" goto Winget_ID_search
if "%scelta%"=="4" goto update_drivers
if "%scelta%"=="5" goto update_windows
if "%scelta%"=="6" goto pulizia
if "%scelta%"=="7" goto salute
if "%scelta%"=="8" goto RAM
if "%scelta%"=="9" goto deframmenta
if "%scelta%"=="00" goto PuntoRipristino
if "%scelta%"=="01" goto Winget
if "%scelta%"=="02" goto Winget_include_unknown
if "%scelta%"=="03" goto Winget_ID_search
if "%scelta%"=="04" goto update_drivers
if "%scelta%"=="05" goto update_windows
if "%scelta%"=="06" goto pulizia
if "%scelta%"=="07" goto salute
if "%scelta%"=="08" goto RAM
if "%scelta%"=="09" goto deframmenta
if "%scelta%"=="10" goto tweak_sistema
if "%scelta%"=="11" goto bloccaSito
if "%scelta%"=="12" goto gestionePC
if "%scelta%"=="13" goto gestioneDisco
if "%scelta%"=="14" goto attivazione
if "%scelta%"=="15" goto valutazione
if "%scelta%"=="16" goto riavvio
if "%scelta%"=="17" goto help
if "%scelta%"=="18" goto end
...
::Ricerca ID Pacchetti Winget
:Winget_ID_search
color 3
cls
echo -----------------------------------------------------------
echo Ricerca Pacchetti ID...
echo -----------------------------------------------------------
timeout /T 1 >nul
set /p nome_pacchetto="Inserisci il nome del pacchetto da cercare: "
winget search "%nome_pacchetto%"
pause
goto menu
...
:attivazione
cls
echo Perchè il programma funzioni bisogna settare il percorso completo del file MAS_AIO_3.7.cmd. Se nn lo si è già fatto, 
echo editare il presente file bat, effettuare una ricerca all'interno con chiave "attivazione" e configurare il 
echo percorso completo dell'ubicazione del file MAS_AIO_3.7.cmd.
echo ad esemipio C:\Users\[nome utente]\Downloads\MAS_AIO_3.7.cmd
echo dopodiche si può anche eliminare il pause presente sotto questo testo (sempre all'interno del file bat)
echo.
::pause
call d:\MAS_AIO_3.7.cmd
goto menu
...
:: Mostra la valutazione per l'installazione del S.O.  Windows 11
:valutazione
color 3
cls
